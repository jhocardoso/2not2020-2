...
// Uma função chama a si mesma com pleo menos um de seus parâmetros com valor alterado
// Toda função recursiva precisa ter PELO MENOS uma condição de saída, insto é, uma possibilidade
...
// eles assumiraão os valores indicados.
