...
// A função tradiconal acima pode ser transformada em uma ARROW FUNCTION
// - Desaparece a palavra function
// - O argumetno não precisa de parênteses
...
// Situação alternativa 2: função com 1+ argumetno
...
// Os parâmetros dos argumetnos são obrigatórios quando nº arguemtnos > 1
let imc2 = (peso, altura) => peso / (altura ** 2)

console.log (imc(87, 1.78))
console.log (imc2(87, 1.78))

// CONCLUSÃO: os parâmetros só podem ser omitidos da lista de argumetnos 
