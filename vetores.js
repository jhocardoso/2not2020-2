...
// Obs.: o retorno de splice() na remoção será um vetor contendo o(s) item(ns) removido(s)
let x3 = vetor1.splice(2, 1)
console.log(vetor1, x3)

// O splice também serve apra fazer substituições
...
// Argumetno como arrow function
vetor1.forEach(fruta => console.log(fruta))

// Argumetno como função tradicional
